        ...
        for season in seasons:
            for ep in season.get("episodes") or []:
                ...
                out.append({
                    ...
                    # Той самий баг незалежно виправлено і в апстрімі (#404) —
                    # detail тут уже завантажено з language=language, тож ім'я з
                    # нього безкоштовно локалізоване, на відміну від сирого
                    # show.title.
